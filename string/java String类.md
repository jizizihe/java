string不可变性,因此每次对String类改变时都会生成一个新的String对象，所以尽量少改变String类。
...
today is nice day,but im crazy
today is nice day,im happy
2020-1-20:today is nice day, im shy
str3 == str4:true
str3 == str4:true
str5 == str6:false
str5 == str6:true
today is nice day,
tomorrow is nice day,im error.
````
